@echo off
REM Run the full app locally: Docker (Postgres + MinIO), backend API, frontend.
REM Usage: run.bat (from repo root)
REM Prerequisites: Docker Desktop, Python 3.12+, Node.js, pip, npm
...
REM Ensure backend .env exists (use defaults matching docker-compose)
